...
export class ArraySummaryPanel extends Panel {
    constructor(data, ...args) {
        ...
        this.summaryHeader = this.container.newChild('div').setElem(this.typename);
        ...
        for (const key in this.table) {
            ...
            this.summaryTable.appendRow([this.doc.newElem('th').setElem(key), value]);
        }
    }
    get typename() {
        if (!this._typename) {
...
export class TableSummaryPanel extends Panel {
    constructor(tbl, ...args) {
        ...
        this.summaryHeader = this.container.newChild('div');
